...
namespace AgentParser\Analyser\Header\Useragent;

use AgentParser\Constants;
use AgentParser\Data;
use AgentParser\Model\Family;
use AgentParser\Model\Using;
use AgentParser\Model\Version;
...
trait Application
{
    ...
    private function detectSpecificApplications($ua)
    {
        ...
        if (preg_match('/Android [0-9\.]+; (.*) Sony\/.*SonySelectSDK\/([0-9\.]+)/iu', $ua, $match)) {
            ...
            $this->data->browser->type = Constants\BrowserType::APP;
            $this->data->browser->using = new \AgentParser\Model\Using([
