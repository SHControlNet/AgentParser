...
use AgentParser\Model\Browser;
use AgentParser\Model\Engine;
use AgentParser\Model\Os;
use AgentParser\Model\Device;

class Main
{
    /**
     * @var \AgentParser\Model\Browser  $browser      Information about the browser
     */
    public $browser;

    /**
     * @var \AgentParser\Model\Engine   $engine       Information about the rendering engine
     */
    public $engine;

    /**
     * @var \AgentParser\Model\Os       $os           Information about the operating system
     */
    public $os;

    /**
     * @var \AgentParser\Model\Device   $device       Information about the device
     */
    public $device;
